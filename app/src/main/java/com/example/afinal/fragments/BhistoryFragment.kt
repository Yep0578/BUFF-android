...
import kotlinx.android.synthetic.main.fragment_bhistory.*
...
class BhistoryFragment : Fragment(){

    val buy_history = "http://${ip}:8080/TestWeb/buff/buy_history.jsp"
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_bhistory,container,false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        address = buy_history + "?username=" + fname
        ...
        HttpUtil.sendByOkHttp(address,object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread {
                    ...
                    bhRecyclerView.layoutManager = layoutManager
                    val adapter = DetailAdapter(result)
                    bhRecyclerView.adapter = adapter
                }
